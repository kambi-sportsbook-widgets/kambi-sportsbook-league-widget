...
const CONFIG = {
  '/football/england/premier_league': [
    ...
    { from: 5, to: 6, color: 'ORANGE', description: 'UEFA Europa League' },
    {
      ...
      to: 7,
      color: 'LIGHT_ORANGE',
      description: 'UEFA Europa League Qualification',
    },
  ...
  '/football/germany/bundesliga': [
    ...
    { from: 8, to: 8, color: 'ORANGE', description: 'UEFA Europa League' },
    {
      from: 6,
      to: 6,
      color: 'LIGHT_ORANGE',
    ...
    },
    {
      ...
      to: 16,
      color: 'LIGHT_RED',
      description: 'Relegation Play-off',
    },
  ...
  '/football/netherlands/eredivisie': [
    ...
    },
    {
      ...
      to: 5,
      color: 'LIGHT_ORANGE',
      description: 'Europa League Play-off',
    },
    {
      from: 6,
      to: 6,
